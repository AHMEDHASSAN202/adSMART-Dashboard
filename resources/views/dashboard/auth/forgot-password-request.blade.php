...
<div class="container-login100" style="background-image: url('{{ asset('dashboard-assets/images/login-bg.jpg') }}');">
    ...
    <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
        ...
        <form method="post" action="{{ route("auth.dashboard.password.request.submit") }}" class="login100-form validate-form" autocomplete="off">
                    <span class="login100-form-title p-b-37">
                        {{ _e('dashboard_forgot_password_title') }}
                    </span>
            ...
            <div class="container-login100-form-btn m-t-10 forget-password">
                <a href="{{ route('auth.dashboard.login') }}" class="txt2 fs-12">{{ _e('signin') }}</a>
            </div>
        </form>
